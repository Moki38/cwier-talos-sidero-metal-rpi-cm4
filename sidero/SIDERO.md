...
Check the sha256 and sha512 checksums
```
sha256 RPi4_UEFI_Firmware_v1.37.zip
sha512 RPi4_UEFI_Firmware_v1.37.zip
```
...
Latest TAG didn't work as planned, use the one returned during make
```
docker buildx create --name local --use

make PLATFORM=linux/arm64 USERNAME=moki38 REGISTRY=docker.io PUSH=true TARGETS=raspberrypi4-uefi
